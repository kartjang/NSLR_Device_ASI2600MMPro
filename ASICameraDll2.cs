...
namespace ZWO_ASI_Test
{
    public class ASICameraDll2
    {
        ...
        public struct ASI_CAMERA_INFO
        {
            ...
            public int NumOfCameras; //23.04.21_JcKJason add 
        ...
        public  int ASIGetNumOfConnectedCameras() { return IntPtr.Size == 8 /* 64bit */ ? ASIGetNumOfConnectedCameras64() : ASIGetNumOfConnectedCameras32(); }
